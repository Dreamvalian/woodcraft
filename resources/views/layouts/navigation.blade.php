    ...
    <div class="container mx-auto px-6 py-6">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('home') }}" class="flex items-center gap-3 group">
                <img src="{{ asset('image/logo2.svg') }}" alt="WoodCraft Logo" class="w-12 transition-transform duration-300 group-hover:scale-105">
            ...
            <div class="flex items-center space-x-8">
                ...
                <a href="{{ route('cart.index') }}" 
                   class="text-[#2C3E50] hover:text-[#E67E22] transition-colors duration-300 relative"
                   title="Shopping Cart">
                    <i class="fas fa-shopping-cart text-lg"></i>
                    @if($cartCount > 0)
                        <span class="absolute -top-2 -right-2 bg-[#E67E22] text-white text-xs rounded-full h-5 w-5 flex items-center justify-center font-light">
                            {{ $cartCount }}
                        </span>
                    @endif
                </a>
