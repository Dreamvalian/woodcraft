...
<div x-data="{ 
  ...
  <div class="mb-6">
    <div class="relative">
      <input type="text" x-model="searchQuery" @input="search()" placeholder="Search products..."
  ...
  {{-- Filters --}}
  <div x-show="isFilterOpen || window.innerWidth >= 768" x-transition:enter="transition ease-out duration-200"
      ...
      <div class="space-y-4">
        <div class="flex items-center space-x-4">
          <div class="flex-1">
            ...
            <input type="number" x-model.number="priceRange.min" @change="search()"
          ...
          <div class="flex-1">
            ...
            <input type="number" x-model.number="priceRange.max" @change="search()"
              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-wood focus:ring-wood sm:text-sm">
          </div>
        </div>
        <div class="relative">
          <div class="h-2 bg-gray-200 rounded-full">
            <div class="absolute h-2 bg-wood rounded-full"
    ...
    <div>
      ...
      <select x-model="sortBy" @change="search()"
