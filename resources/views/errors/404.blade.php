        ...
        <div class="mt-12">
            ...
            <form action="{{ route('search') }}" method="GET" class="max-w-md mx-auto">
                <div class="flex">
                    ...
                    <button 
                        type="submit"
                        class="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-r-md text-white bg-wood hover:bg-wood-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-wood"
                    >
