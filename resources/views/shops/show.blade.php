...
<div class="bg-white font-sans">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div class="space-y-8">
                <div>
                    <h1 class="text-3xl font-medium text-gray-900">{{ $shop->name }}</h1>
                    <p class="mt-3 text-2xl text-gray-600">{{ $shop->formatted_price }}</p>
                </div>
                ...
                <div class="border-t border-gray-200 pt-8">
                    <dl class="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-2">
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-600">{{ $shop->material }}</dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-900">Dimensions</dt>
                            <dd class="mt-1 text-sm text-gray-600">{{ $shop->dimensions }}</dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-900">Weight</dt>
                            <dd class="mt-1 text-sm text-gray-600">{{ $shop->weight }} kg</dd>
                        </div>
                        <div>
            ...
            <div class="mt-20">
                ...
                <div class="grid grid-cols-1 gap-y-12 gap-x-6 sm:grid-cols-2 lg:grid-cols-4">
                    @foreach($relatedShops as $relatedShop)
                        <div class="group">
                            <a href="{{ route('shops.show', $relatedShop) }}" class="block relative overflow-hidden rounded-lg bg-gray-50">
                            ...
                            <div class="mt-4 space-y-2">
                                ...
                                <p class="text-gray-600">{{ $relatedShop->formatted_price }}</p>
                            </div>
                        </div>
                    @endforeach
                </div>
