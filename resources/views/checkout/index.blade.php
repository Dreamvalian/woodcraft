        ...
        <div class="p-6 bg-white border-b border-gray-200">
          <div x-data="checkout()" class="space-y-8">
            ...
            <div class="text-gray-600">
              ...
              <p x-text="'{{ $address->city }}, {{ $address->state }} {{ $address->postal_code }}'">
              </p>
          ...
          @endforeach
                ...
                <form @submit.prevent="saveAddress" class="space-y-4">
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="text" x-model="newAddress.full_name"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    <div>
                      <label class="block text-sm font-medium text-gray-700">Phone</label>
                      <input type="text" x-model="newAddress.phone"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    <div class="md:col-span-2">
                      <label class="block text-sm font-medium text-gray-700">Address Line
                        1</label>
                      <input type="text" x-model="newAddress.address_line1"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    <div class="md:col-span-2">
                      <label class="block text-sm font-medium text-gray-700">Address Line
                        2</label>
                      <input type="text" x-model="newAddress.address_line2"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <input type="text" x-model="newAddress.state"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <input type="text" x-model="newAddress.country"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                  </div>
                  <div class="flex items-center">
              ...
              <div class="space-y-4">
                <div class="border rounded-lg p-4 cursor-pointer hover:border-blue-500"
                  ...
                  <div class="flex justify-between items-center">
                    ...
                    <div class="text-lg font-medium" x-text="formatPrice(standardShippingCost)">
                    </div>
                  </div>
                </div>
                <div class="border rounded-lg p-4 cursor-pointer hover:border-blue-500"
                  ...
                  <div class="flex justify-between items-center">
                    ...
                    <div class="text-lg font-medium" x-text="formatPrice(expressShippingCost)">
                    </div>
                  </div>
                </div>
                <div class="border rounded-lg p-4 cursor-pointer hover:border-blue-500"
                  ...
                  <div class="flex justify-between items-center">
                    ...
                    <div class="text-lg font-medium" x-text="formatPrice(overnightShippingCost)">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div x-show="currentStep === 3">
              ...
              <div class="space-y-6">
                ...
                <!-- Order Notes -->
                <div>
                  <label class="block text-sm font-medium text-gray-700">Order Notes
                    (Optional)</label>
                  <textarea x-model="orderNotes" rows="3"
            ...
            <div class="flex justify-between mt-8">
              <button x-show="currentStep > 0" @click="previousStep"
              ...
              <button x-show="currentStep === steps.length - 1" @click="placeOrder"
