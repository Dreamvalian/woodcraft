                ...
                <div class="space-y-4">
                    <div class="flex items-center">
                        ...
                        <label for="terms" class="ml-2 block text-sm font-light text-gray-600">
                            I agree to the <a href="#" class="text-[#E67E22] hover:text-[#2C3E50] transition duration-300">Terms of Service</a> and <a href="#" class="text-[#E67E22] hover:text-[#2C3E50] transition duration-300">Privacy Policy</a>
                        </label>
                    </div>
                    <button type="submit" class="w-full py-2 px-4 bg-[#2C3E50] hover:bg-[#E67E22] text-white font-light rounded-lg shadow-lg focus:outline-none focus:ring-2 focus:ring-[#E67E22] focus:ring-offset-2 transition duration-300">Create Account</button>
                </div>
            </form>
