            ...
            <div class="w-full max-w-md bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl p-8 border border-white/20">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}"
                                class="text-sm font-light text-[#E67E22] hover:text-[#2C3E50] transition duration-300">Forgot
                                password?</a>
                        @endif
                    </div>
                    <div>
                ...
                <div class="mt-8 text-center text-sm font-light text-gray-600">
                    ...
                    <a href="{{ route('register') }}"
                        class="text-[#E67E22] hover:text-[#2C3E50] font-medium transition duration-300">Create Account</a>
                </div>
            </div>
        </div>
    </div>
