    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        <label for="min_order_quantity" class="block text-sm font-medium text-[#2C3E50] mb-1">Min Order Quantity</label>
                        <input type="number" name="min_order_quantity" id="min_order_quantity" value="{{ old('min_order_quantity', 1) }}"
                               class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-[#E67E22] focus:border-transparent">
                    </div>

                    <div>
                        <label for="max_order_quantity" class="block text-sm font-medium text-[#2C3E50] mb-1">Max Order Quantity</label>
                        <input type="number" name="max_order_quantity" id="max_order_quantity" value="{{ old('max_order_quantity') }}"
                               class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-[#E67E22] focus:border-transparent">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-[#7f8c8d]">Enter features as a JSON object, e.g., {"color": "natural", "style": "modern"}</p>
                </div>
